          ...
          <div className='space-y-8'>
            ...
            <div className='space-y-4'>
              ...
              <p className='text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200'>
                Hi, I'm Victor Oyebanji a Web Developer specializing in React.js, 
                Django and Wordpress, I build scalable performance web applications
                that users love
              </p>
            </div>
            {/* CTAs */}
          ...
          {/* Profile Image */}
              ...
              />
                <div className='relative glass rounded-3xl p-2 glow-border'>
                  <img src="/hero-img.png" alt="" className='w-full aspect[4/5] object-cover rounded-2xl' />
          ...
          <div className='relative overflow-hidden'>
            <div className='flex animate-marquee'>{[...skills, ...skills].map((skill, index)=>(
              <div key={index}className='flex-shrink-0 px-8 py-4'>
                <span className='text-xl font-semibold text-muted-foreground/50 hover:text-muted-foreground transitions-colors'>{skill}</span>
              </div>
            ))}
            </div>
          </div>
